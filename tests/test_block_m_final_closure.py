...
class BlockMFinalClosureTests(unittest.TestCase):
    ...
    def test_architecture_tripwires_remain_present(self) -> None:
        ...
        self.assertIn("verify.project-check.fastpath-rejected", verifier_source)
        self.assertIn("_disable_prepared_snapshot_fastpath(", verifier_source)
        self.assertIn("_allow_prepared_fastpath=False", verifier_source)
