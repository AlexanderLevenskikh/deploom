...
export type BaselineIntent = { schemaVersion: 1; policies: Record<string, BaselinePackagePolicy>; extraIterations?: number; decisionGrantIterations?: number; searchMode?: BaselineSearchMode; executionMode?: BaselineExecutionMode }
...
export type BaselineCohortSuggestion = { id: string; label: string; predicate: string; subject?: string; packages: string[]; requiredPackages?: string[]; confidence: number; reasons?: string[]; authority: 'DIAGNOSTIC_HINT' }
