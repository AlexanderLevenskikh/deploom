      ...
      <div className="flow-layout">
        ...
        <div className="stage-detail">
          ...
          <div className="stage-actions">
            ...
            {FLOW_STAGES[displayedIndex].action === 'baseline' ? <button className="button secondary" disabled={active} onClick={() => restartBaseline(displayedIndex)}><RotateCcw size={16} /> {text('Начать заново', 'Start over')}</button> : null}
