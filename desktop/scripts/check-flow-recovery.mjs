...
const cases = [
  ...
  ["MIGRATION_VERIFICATION_TIMEOUT: yarn test", "agent", "infrastructure"],
  ["LIVE_BASELINE_INSTALL_TIMEOUT: yarn install", "agent", "infrastructure"],
  ["LIVE_BASELINE_COMMAND_TIMEOUT: yarn test", "agent", "infrastructure"],
